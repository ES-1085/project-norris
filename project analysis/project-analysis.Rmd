...
~~ Jo: alt text ends at metal category pie chart
~~ Cedar: figure out if document will knit
~~ Cedar: remove duplicate code chunks/rename code chunks
...
# how to change the variable names on the table??????
# also should we try to explain NA values
...
# is it better to say grouped or faceted in the alt text?
...
# change labels on pie chart so they're external instead of internal (easier to read)
  # also change them to percentages instead of decimals
