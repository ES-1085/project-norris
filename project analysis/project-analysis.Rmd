...
```{r chemical-use-by-facility, echo = FALSE, message = FALSE}
chemical_analysis_data %>% 
...
```{r chem-analysis-facility-map, echo = FALSE, message = FALSE}
# chemical_analysis_data %>% 
#   label <- sprintf(facility_name, "<br>", parent_co_name, "<br>", industry_sector, "<br>", chemical, "<br>", city, ", ", state)
# 
# chemical_analysis_data %>% 
#   select(longitude, latitude, facility_name, parent_co_name, industry_sector, city, state, chemical) %>% 
#   distinct(longitude, latitude, facility_name, parent_co_name, industry_sector, city, state, .keep_all = TRUE) %>% 
#   leaflet() %>% 
#   addTiles() %>% 
#     addCircleMarkers(lng = ~longitude, 
#                  lat = ~latitude, 
...
```{r chemical-use-on-tribal-lands}
chemical_analysis_data %>% 
...
```{r plot-off-site-release-total-by-chemical}
chemical_analysis_data %>% 
...
```{r plot-off-site-recycled-total-by-chemical}
chemical_analysis_data %>% 
...
```{r off-site-energy-recovery-total-by-chemical}
chemical_analysis_data %>% 
...
```{r off-site-treated-total-by-chemical}
chemical_analysis_data %>% 
...
```{r plot-total-transfer-by-chemical}
chemical_analysis_data %>% 
...
```{r plot-total-releases-by-chemical}
chemical_analysis_data %>% 
