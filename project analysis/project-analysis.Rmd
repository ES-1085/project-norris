...
The percentage of facilities on tribal land is less than 1%, but this does not make it negligible as the impact remains significant.
...
There are `sum(tri_data$carcinogen == "YES")` carcinogens being observed -- a large number creating a small percentage.
...
There are `sum(tri_data$carcinogen == "NO")` non-carcinogens being observed.
...
There are `sum(tri_data$pfas == "YES")` observations of PFAS chemicals in the dataset.
...
There are `sum(tri_data$pfas == "NO")` observations of non-PFAS chemicals in the dataset.
...
There are `sum(tri_data$pbt == "YES")` observations of PBT chemicals in the dataset.
...
There are `sum(tri_data$pbt == "NO")` observations of non-PBT chemicals in the dataset.
